...
2. **Role** (Роль) - справочник ролей пользователей
3. **UserRole** (Роль пользователя) - связь многие-ко-многим между пользователями и ролями
4. **ServiceCategory** (Категория услуги) - справочник категорий услуг
5. **Service** (Услуга) - услуги МФЦ
6. **MFCOffice** (Отделение МФЦ) - отделения МФЦ
7. **Appointment** (Запись на приём) - записи пользователей на приём
8. **Request** (Заявка) - заявки на услуги
9. **Document** (Документ) - документы, прикреплённые к заявкам (работа с изображениями)
